...
function OurBlockchainDevelopmentProcess() {
  const ProcessDetail = ({
    ...
    const myClassName = isVertical
      ? "max-w-[674px] text-justify text-[18px] font-normal relative after:block after:absolute after:bg-[#FF1C03] after:h-[59px] after:w-[1px] whitespace-pre-line "
      : "max-w-[674px] text-justify text-[18px] font-normal";
    return (
  ...
  return (
    <section className="OurBlockchainDevelopmentProcess px-[162px]">
      <div>
        <h1>Our Blockchain Development Process</h1>
        {/* row 1  */}
        <ProcessDetail
          isVertical={true}
          imgSrc={Rectangle12}
          ...
          para=" We look at your project requirements at this stage. We try to get
              a sense of what blockchain solutions you need. Each blockchain
              network (public, private, and hybrid) has distinct pluses and
              minuses. 

              So, we decide which one will best drive your goals. In
              short, we gather all requirements at this stage and form an
              initial workflow based on that"
        />
        <ProcessDetail
        isVertical={true}
          imgSrc={Rectangle13}

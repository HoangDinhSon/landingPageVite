import { iconfacebook, icontwiter } from '../assets/icons';

function Footer() {
    return (
        <div
            id="contact"
            className="relative h-[821px] bg-[url('./assets/icons/Footer/people.jpg')] bg-no-repeat my-pg-position text-white sm:h-[600px] "
        >
            {/* row 1  */}
            <div className="absolute w-full top-[25%] left-1/2 -translate-x-2/4 flex flex-col items-center ">
                <h2 className="uppercase text-center text-[28px]">Begin your journey with us</h2>
                <h3 className="text-center text-[35px] sm:text-[20px]">We'd love to see how we can hely you </h3>
            ...
            <div className="bg-[#991217] text-white h-[45px] w-full flex justify-around items-center absolute bottom-0 left-0 ">
                ...
                <div className="flex gap-5 sm:gap-3">
                    ...
                    <img src={icontwiter} alt="" className="object-obtain  text-[red]  w-5 h-5" />
                </div>
            </div>
        </div>
    );
